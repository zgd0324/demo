                        ...
                        0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function (n, r) {
                            ...
                            if (void 0 !== v && null !== v || (v = ""), !r.colGroup) {
                                var m = ['<td data-field="' + c + '" data-key="' + h + '" ' + function () {
                                    ...
                                    if(r.toolbar === undefined && r.templet === undefined && r.type !== 'numbers' && r.type !== 'checkbox' && r.type !== 'radio'){
                                    	return '<div class="layui-table-cell laytable-cell-' + function () {
                                            return "normal" === r.type ? h : h + " laytable-cell-" + r.type
                                        }() + '" lay-tips="' + function () {
                                        	var n = t.extend(!0, {LAY_INDEX: g}, l);
        	                                return i(t(r.templet).html() || String(v)).render(n)
        		                        }() 
                                    }else{
                                    	return '<div class="layui-table-cell laytable-cell-' + function () {
                                            return "normal" === r.type ? h : h + " laytable-cell-" + r.type
